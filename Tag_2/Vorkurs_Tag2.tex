...
%TODO verständlich machen
%TODO kleines beispiel eines boolischen ausdruckes für nächste aufgabe
\begin{frame}
...
if (answer == "Cake") {
	...
	System.out.println("Not to everything, but very commendable");
} else {
